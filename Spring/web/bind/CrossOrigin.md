...
Spring Web MVC 和 Spring WebFlux 都在各自的模块中通过 RequestMappingHandlerMapping 支持这个注解。每个类型和方法级别注释对的值都被添加到一个CorsConfiguration中，然后通过CorsConfiguration. applypermitdefaultvalues\(\)应用默认值。
